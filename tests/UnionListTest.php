...
class UnionListTest extends SapphireTest
{
    ...
    /**
     * For Silverstripe 4 support (when this module gets upgraded)
     *
     * @return array
     */
    ...
    {
        parent::setUp();
        $obj3 = DataObjectTest_ValidatedObject::get()->find('Name', 'test obj 3');
        $obj4 = DataObjectTest_ValidatedObject::get()->find('Name', 'test obj 4');
        $this->assertTrue($obj3->isInDB());
        $this->assertTrue($obj4->isInDB());

        $list1 = DataObjectTest_ValidatedObject::get()->filter(array('Name' => 'test obj 1'));
        $list2 = DataObjectTest_ValidatedObject::get()->filter(array('Name' => 'test obj 2'));
    ...
    public function testExists()
    {
        ...
        $unionList = UnionList::create(array(DataObjectTest_ValidatedObject::get()->filter(array('Name' => 'non existant'))));
